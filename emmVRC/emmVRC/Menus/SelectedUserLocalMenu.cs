    ...
    public class SelectedUserLocalMenu : MelonLoaderEvents
    {
        ...
        public override void OnSceneWasLoaded(int buildIndex, string sceneName)
        {
            ...
            playerNotesButton = new SimpleSingleButton(selectedUserGroup, "Player\nNotes", () => {
                APIUser selectedUser =APIUser.CurrentUser;
            ...
            teleportButton = new SimpleSingleButton(selectedUserGroup, "Teleport", () => {
                VRC.Player selectedPlayer = PlayerManager.field_Private_Static_PlayerManager_0.field_Private_List_1_Player_0.ToArray().FirstOrDefault(a => a.field_Private_APIUser_0 != null);
