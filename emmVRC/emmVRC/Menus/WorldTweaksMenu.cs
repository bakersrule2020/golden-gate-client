...
namespace emmVRC.Menus
{
    ...
    public class WorldTweaksMenu : MelonLoaderEvents
    {
        ...
        private static void OpenMenu()
        {
            ...
            itemEspToggle.SetInteractable(Configuration.JSONConfig.RiskyFunctionsEnabled);
            triggerEspToggle.SetInteractable(Configuration.JSONConfig.RiskyFunctionsEnabled);
            pickupsToggle.SetInteractable(Configuration.JSONConfig.RiskyFunctionsEnabled);
            pickupVisibilityToggle.SetInteractable(Configuration.JSONConfig.RiskyFunctionsEnabled);
