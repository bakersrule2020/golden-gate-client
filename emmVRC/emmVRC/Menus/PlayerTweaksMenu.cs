...
namespace emmVRC.Menus
{
    ...
    public class PlayerTweaksMenu : MelonLoaderEvents
    {
        ...
        private static void OpenMenu()
        {
            ...
            jumpingToggleButton.SetText(Functions.PlayerHacks.Jump.IsEnabled ? "Disable\nJump" : "Enable\nJump");
            jumpingToggleButton.SetInteractable(Configuration.JSONConfig.RiskyFunctionsEnabled);
            waypointsButton.SetInteractable(Configuration.JSONConfig.RiskyFunctionsEnabled);
            flightToggle.SetInteractable(Configuration.JSONConfig.RiskyFunctionsEnabled);
            noclipToggle.SetInteractable(Configuration.JSONConfig.RiskyFunctionsEnabled);
            speedToggle.SetInteractable(Configuration.JSONConfig.RiskyFunctionsEnabled);
            speedSlider.SetInteractable(Configuration.JSONConfig.RiskyFunctionsEnabled);
            espToggle.SetInteractable(Configuration.JSONConfig.RiskyFunctionsEnabled);
